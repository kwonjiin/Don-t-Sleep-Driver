...
EAR_DROP_RATIO = 0.5  # 눈 크기가 초기 값의 50% 이하로 줄어들면 경고
...
def drowsiness_detection(callback):
    global initial_ear, initial_mouth_height
    ...
    while cap.isOpened():
        ...
        for face in faces:
            ...
            conditions_met = sum([
                ear < initial_ear * EAR_DROP_RATIO,  # 눈 크기 감소
                mouth_height > initial_mouth_height + YAWN_THRESHOLD,  # 입 크기 증가
                head_tilt > initial_head_tilt + HEAD_TILT_THRESHOLD  # 고개 숙임
            ])
